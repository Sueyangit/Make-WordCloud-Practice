# -*- coding: utf-8 -*-
"""
Created on Sat Aug 18 10:35:16 2018
...
text_path = 'HJSD.txt' #设置要分析的文本路径
font_path = 'D:\Anaconda3\Lib\site-packages\matplotlib\mpl-data\fonts\ttf\simhei.ttf' # 为matplotlib设置中文字体路径没
